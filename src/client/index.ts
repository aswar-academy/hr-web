...
export type { PaginatedAttendance } from './models/PaginatedAttendance';
export type { PaginatedDepartment } from './models/PaginatedDepartment';
export type { PaginatedTask } from './models/PaginatedTask';
export type { PaginatedUser } from './models/PaginatedUser';
