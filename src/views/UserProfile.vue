      ...
      <v-row>
        <v-col cols="3">
          ...
          <div class="pt-4">
            ...
            <p class="text--secondary"><v-icon>mdi-web</v-icon> Aswar Academy</p>
          </a>
          </div>
          <div>
            ...
            <div><a href="mailto:user.email" style="text-decoration: none;">
            <p class="text-truncate"><v-icon class="mr-1">mdi-email</v-icon>{{ user.email }}</p>
          </a></div>
          </div>
        </v-col>
